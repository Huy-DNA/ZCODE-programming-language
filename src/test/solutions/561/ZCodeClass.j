...
.method public static say(Ljava/lang/String;)V
Label0:
...
Label2:
	ldc "Hello World!
"
	invokestatic ZCodeClass/say(Ljava/lang/String;)V
	ldc "Hi"
	putstatic ZCodeClass/str Ljava/lang/String;
	getstatic ZCodeClass/str Ljava/lang/String;
	invokestatic ZCodeClass/say(Ljava/lang/String;)V
	ldc "
"
	invokestatic ZCodeClass/say(Ljava/lang/String;)V
