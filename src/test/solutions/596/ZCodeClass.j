...
.method public static any(ZZZ)Z
Label0:
.var 0 is b1 Z from Label0 to Label1
.var 1 is b2 Z from Label0 to Label1
.var 2 is b3 Z from Label0 to Label1
	iload_0
	iload_1
	ior
	iload_2
...
Label2:
	...
	iconst_0
	iconst_1
	invokestatic ZCodeClass/any(ZZZ)Z
